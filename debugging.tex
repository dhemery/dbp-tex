...
% e-TeX
% 0: batch mode (nonstop + don't log to terminal)
% 1: nonstop mode (scroll mode + continue after error)
% 2: scroll mode (error stop mode + continue after message)
% 3: error stop mode (stop at errors)
\interactionmode=1 % nonstop mode
