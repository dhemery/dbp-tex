...
\def\headline{\vbox to 0pt{\positionhead\line{\vbox to \textsize{}\runningheadtype\the\head}\vss}\nointerlineskip}
\def\footline{\vbox to 0pt{\positionfoot\line{\runningheadtype\the\foot}\vss\nointerlineskip}}
\def\positionhead{\kern-\headskip}
