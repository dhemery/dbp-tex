...
\def\outputnotes{
  ...
  \line{
    \runningheadtype \nv
    \the\vsize\ (\the\textblockheightadjustment)
    \hfil
...
\def\footline{\baselineskip=\footskip \advance\baselineskip by -\textblockheightadjustment \lineskiplimit=0pt \line{\runningheadtype\the\foot}}
