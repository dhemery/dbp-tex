...
\catcode`\~=13 \def~{\penalty10000\ }% Tilde is active
...
\def\ldots{\hairnbsp.\thinnbsp.\thinnbsp.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\nbsp{~}
\def\enspace{\hskip.5em} \def\ennbsp{\kern.5em}
\def\thinspace{\hskip.2em} \def\thinnbsp{\kern.2em}
\def\hairspace{\hskip.1em} \def\hairnbsp{\kern.1em}
