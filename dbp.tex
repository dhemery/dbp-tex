...
\def\loadfont#1#2{\global\expandafter\font#1=\fontfilename\makeexpandable{#1}}

\def\selectfont#1{%
  \edef\selectedfonttag{\fonttag{#1}}%
  \ifcsname\selectedfonttag\endcsname%
  \else%
    \loadfont{\csname\selectedfonttag\endcsname}{\fontfilename}%
  \fi%
