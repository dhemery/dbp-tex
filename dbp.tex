...
\def\withfontswitch#1{\edef\fontfoo{#1}}

\def\loadfont#1#2{\global\expandafter\font#1=\fontspec\makeexpandable{#1}}

\def\selectfont#1{%
  \edef\selectedfonttag{\fonttag{#1}}
  \unless\ifcsname\selectedfonttag\endcsname
    \loadfont{\csname\selectedfonttag\endcsname}{\fontspec}%
  \fi%
  \def\selectedfont{\csname\selectedfonttag\endcsname}%
  \selectedfont%
}
