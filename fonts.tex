...
% #1: typeface name
% #2: ftag to select the scheme's typeface
% #3: ftag (if any) to select the typefac's regular weight (rg)
% #4: ftag to select the typefac's italic slant (it)
% #5: ftag to select the typefac's bold weight (bf)
% #6: ftag (if any) to select the typefac's regular weight, roman slant (rg, rm)
