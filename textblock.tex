...
\def\normaltextblock{\adjusttextblockheight{0pt}{0}}

\def\runpageslong#1{\adjusttextblockheight{\leading}{#1}}
\def\runpagesshort#1{\adjusttextblockheight{-\leading}{#1}}
\def\runthispagelong{\runpageslong{1}}
\def\runthispageshort{\runpagesshort{1}}


\def\adjusttextblockheight#1#2{
  \global\textblockheightadjustment=#1
  \global\vsize=\textblockheight
    \global\advance\vsize by \textblockheightadjustment
