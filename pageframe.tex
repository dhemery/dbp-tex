...
\def\displayfoot{\style{runninghead}\sc\hfil\folio\hfil}
...
\def\normalrectopagehead{\style{runninghead}\sc\title\hfil\folio }
% Verso pages: page number at edge margin, author name at spine margin
\def\normalversopagehead{\style{runninghead}\sc\folio\hfil\author}
